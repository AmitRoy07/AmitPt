      ...
      <div className={`${styles.custom_container} ${global.container}`}>
        <div className={styles.inner_header}>
          ...
          <nav className={styles.nav}>
            <div className={styles.nav_list}>
              {NavMenu.map((item) => (
                <Link
                  key={item.ID}
                  className={`${styles.nav_item} ${global.body}`}
                  href={"#"}>
                  {item.name}
                </Link>
              ))}
          ...
          <button className={styles.app_header__switch}>
            ...
            <div
              className={`${styles.app_header__switch_i} ${styles.switch_i_sun}`}>
              <img src={UTILITY_CONSTANT.IMAGE.COMMON.SUN} alt='sun' />
            </div>
            <div
              className={`${styles.app_header__switch_i} ${styles.switch_i_moon}`}>
